...
public class JavassitTest {
    public static void main(String[] args) throws Throwable {
        ...
        CtClass cc = pool.get("com.roboslyq.core.bytecode.HelloWorldBean");
        CtMethod m = cc.getDeclaredMethod("sayHello");
        m.insertBefore("System.out.println(\"before=------\");");
        m.insertAfter("System.out.println(\"after=------\");");
        cc.setSuperclass(pool.get("com.roboslyq.core.bytecode.BytecodeParent"));
        ...
        Class c = cl.loadClass("com.roboslyq.core.bytecode.HelloWorldBean");
